...
namespace Sample.Persistence.Migrations
{
    ...
    [Migration("20210324083727_Migration_3")]
            ...
            modelBuilder.Entity("Sample.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 3, 24, 11, 37, 27, 40, DateTimeKind.Local).AddTicks(7377),
                            CreatedBy = "admin",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2021, 3, 24, 11, 37, 27, 41, DateTimeKind.Local).AddTicks(8286),
                            CreatedBy = "admin",
                            DisplayName = "USER 2",
